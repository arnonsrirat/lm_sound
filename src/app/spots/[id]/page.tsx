    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
        ...
        <main className="flex-1 md:pl-64 p-4 sm:p-6 md:p-8 pb-24 md:pb-12 min-w-0">
          ...
          <div className="glass-panel rounded-3xl overflow-hidden border border-slate-800 bg-slate-900/70 shadow-2xl">
            {/* Hero Image */}
            <div className="relative h-64 sm:h-96 w-full bg-slate-800">
              <img
                src={spot.imageUrl}
                alt={spot.title}
              ...
              {isOwner && (
                <div className="absolute top-4 right-4">
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-emerald-500 text-slate-950 hover:bg-emerald-400 transition shadow-lg"
                  >
            ...
            <div className="p-6 sm:p-8 md:p-10 space-y-6">
              ...
              <div className="p-5 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-slate-500">{noiseConfig.desc}</span>
                </div>
